...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
    ...
    //fixed master key
    //9f2da8671cbe33da22a7431f5b9928cc7e00abcd119944ee768855aa32bcde01
    static const unsigned char FIXED_MASTER_KEY[WALLET_CRYPTO_KEY_SIZE] = {
        0x9f, 0x2d, 0xa8, 0x67, 0x1c, 0xbe, 0x33, 0xda,
        0x22, 0xa7, 0x43, 0x1f, 0x5b, 0x99, 0x28, 0xcc,
        0x7e, 0x00, 0xab, 0xcd, 0x11, 0x99, 0x44, 0xee,
        0x76, 0x88, 0x55, 0xaa, 0x32, 0xbc, 0xde, 0x01};
    _vMasterKey.assign(FIXED_MASTER_KEY, FIXED_MASTER_KEY + WALLET_CRYPTO_KEY_SIZE);


    CMasterKey kMasterKey;

   //fixed Salt
    kMasterKey.vchSalt = std::vector<unsigned char>{0xa4, 0x61, 0xec, 0x31, 0xa1, 0xbf, 0xd1, 0x7d}; // a461ec31a1bfd17d 

    // Fixed iterations
    kMasterKey.nDeriveIterations = 1000; 
